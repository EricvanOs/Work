...
$bicepFile = "C:\Work\Azure\Biceps\AzureDeploy_06.bicep"
New-AzResourceGroupDeployment -Name firstbicep -ResourceGroupName myResourceGroup -TemplateFile $bicepFile
