...
$quote[0].column1.Trim()  | out-file -FilePath 'C:\Utils\BGInfo\quote.txt' -encoding ASCII 
...
$mythology[0].column1.Trim() | out-file -FilePath 'C:\Utils\BGInfo\mythology.txt' -encoding ASCII
