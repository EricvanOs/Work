...
Get-WmiObject "Win32_Service" | Where-Object{$_.processid -eq 652} | select-object -Property name



Foreach($p in $processes)
{
  $services = Get-WmiObject 'Win32_Service' | Where-Object{$_.processid -eq $p.id}
