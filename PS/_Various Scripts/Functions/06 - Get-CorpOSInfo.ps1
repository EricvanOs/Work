...
#>
    ...
    PROCESS {
        foreach ($computer in $ComputerName) {
            ...
            $compsys = Get-CimInstance -ComputerName $computer -ClassName Win32_ComputerSystem -ErrorAction SilentlyContinue
            $bios = Get-CimInstance -ComputerName $computer -ClassName Win32_BIOS -ErrorAction SilentlyContinue
...
Get-CorpOSInfo -ComputerName lon-dc01

'lon-dc01','lon-srv99' | Get-CorpOSInfo