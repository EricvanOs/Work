...
$csvFiles = Get-ChildItem -Path $csvPath -Filter '*changes*'
Foreach ($File in $csvFiles) {
	Write-Host "Getting file " $File.FullName -ForegroundColor blue
...
# cleanup
$query = "IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[$TableName]') AND type in (N'U')) DROP TABLE [dbo].[$TableName]"
